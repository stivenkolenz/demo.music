<tr data-req="[{ ID }]" class="ReqTr" [{ RATE }]data-rate="[{ RATE }]"[{ /RATE }]>
	<td class="ReqTr__rate" [{ RATE }]data-rate="[{ RATE }]"[{ /RATE }]>[{ RATE_AVG }]</td>
	<td class="ReqTr__id">№[{ ID }]</td>
	<td class="ReqTr__date">[{ DATE }]</td>
	<td class="ReqTr__email">
		[{ EMAIL }]
		<a href="mailto:[{ EMAIL }]">
	...
	<td class="ReqTr__user">[{ USER }]</td>
	<td class="ReqTr__nickname">[{ NICKNAME }]</td>
	<td class="ReqTr__stages">
		<div class="Stages flex">
            <a class="Stages__el flex flex--aic flex--jcc Stages__el--[{ STAGE_1 }]" href="/su/req/[{ ID }]/stage/1">#1</a>
            <a class="Stages__el flex flex--aic flex--jcc Stages__el--[{ STAGE_2 }]" href="/su/req/[{ ID }]/stage/2">#2</a>
            <a class="Stages__el flex flex--aic flex--jcc Stages__el--[{ STAGE_3 }]" href="/su/req/[{ ID }]/stage/3">#3</a>
        </div>
	</td>
	<td class="ReqTr__opt">
		<input type="checkbox" name="req[]" value="[{ ID }]" class="change_req_id">
	</td>
</tr>